...
%>
	<nav class="navbar navbar-expand-lg navbar-light bh-light"> <!-- 제목 -->
		<!-- navbar-brand = 로고같은걸 출력 -->
		<a class="navbar-brand" href="index.jsp">강의평가 웹 사이트</a>
		<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar">
			<span class="navbar-toggler-icon"></span> <!-- 햄버거 메뉴 -->
		</button>
...
%>
	...
	<section class="container">
		<form method="get" action="./index.jsp" class="form-inline mt-3">
			...
			<input type="text" name="search" class="from-control mx-1 mt-2" placeholder="내용을 입력하세요.">
			<button type="submit" class="btn btn-priary mx-1 mt-2">검색</button>
...
%>
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
				<%= evaluation.getEvaluationTitle() %>&nbsp;<small>(<%= evaluation.getLectureYear() %>년 <%= evaluation.getSemesterDivide() %>)</small></h5>
